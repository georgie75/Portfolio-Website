...
import Logo from "@/assets/Neonlogo.3 (2).png"; // Adjust the path as necessary
  ...
  return (
    <nav className={cn("fixed w-full z-40 transition-all duration-300", isScrolled ? "py-3 bg-background/80 backdrop-blur-md shadow-xs" : "py-5")}>
      <div className="container flex items-center justify-between">
        <a className="text-xl font-bold text-glow text-foreground flex items-center" href="#hero">
          <img src={Logo} alt="GeorgeKotch Logo" className="h-auto w-20 relative z-30  " />
